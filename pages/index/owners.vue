		...
		<div
			...
			<div
				...
				<div
					...
					<div @click="flag = true" class="flex gap-2">
						<input
							id="item-others"
							type="radio"
							class="self-start rounded scale-105"
				...
				<div class="flex flex-col gap-4" v-else-if="flag === true">
					...
					<div class="flex gap-4 pt-2">
						...
						<button class="button-style-gray" @click="flag = false">
							Cancel
						</button>
					</div>
				</div>
			</div>
			<div v-else class="flex w-11/12 flex-col justify-center box-styling">
				<h1 class="md:text-3xl text-xl font-bold">Company owner</h1>
				<div class="w-full grid grid-auto-column gap-4">
